angular.module("gsja_tesalonika_app.controllers", [])
...
.controller("side_menusCtrl", function($ionicConfig,$scope,$rootScope,$state,$location,$ionicScrollDelegate,$ionicListDelegate,$http,$httpParamSerializer,$stateParams,$timeout,$interval,$ionicLoading,$ionicPopup,$ionicPopover,$ionicActionSheet,$ionicSlideBoxDelegate,$ionicHistory,ionicMaterialInk,ionicMaterialMotion,$window,$ionicModal,base64,md5,$document,$sce,$ionicGesture,$translate,tmhDynamicLocale){
	...
	popover_template += "			<a  class=\"item dark-ink\" ng-href=\"#/gsja_tesalonika_app/about_us\" ng-click=\"popover.hide()\">";
        ...
        if(ima_session === null){
            ...
            $http.get("http://beliaccessories.com/apps/gsja_tesalonika/rest_api.php?json=me").then(function(resp){
                ...
                if(resp.data.data.status == 401){
        			...
        			$state.go("gsja_tesalonika_app.welcome");
...
$rootScope.radioRadioURL = "http://67.55.64.164:8000/;stream.mp3?_=3";
...
// TODO: englishserviceCtrl --|-- 
.controller("englishserviceCtrl", function($ionicConfig,$scope,$rootScope,$state,$location,$ionicScrollDelegate,$ionicListDelegate,$http,$httpParamSerializer,$stateParams,$timeout,$interval,$ionicLoading,$ionicPopup,$ionicPopover,$ionicActionSheet,$ionicSlideBoxDelegate,$ionicHistory,ionicMaterialInk,ionicMaterialMotion,$window,$ionicModal,base64,md5,$document,$sce,$ionicGesture,$translate,tmhDynamicLocale){
	...
	// TODO: englishserviceCtrl --|-- $scope.scrollTop
	$rootScope.scrollTop = function(){
		$timeout(function(){
			$ionicScrollDelegate.$getByHandle("top").scrollTop();
		},100);
	};
	// TODO: englishserviceCtrl --|-- $scope.toggleGroup
	$scope.toggleGroup = function(group) {
		if ($scope.isGroupShown(group)) {
			$scope.shownGroup = null;
		} else {
	...
	// TODO: englishserviceCtrl --|-- $scope.redirect
	// redirect
	$scope.redirect = function($url){
		$window.location.href = $url;
	};
	...
	// TODO: englishserviceCtrl --|-- controller_by_user
	// controller by user 
	function controller_by_user(){
		try {
			...
			console.log("%cerror: %cPage: `englishservice` and field: `Custom Controller`","color:blue;font-size:18px","color:red;font-size:18px");
			console.dir(e);
		}
	}
	$scope.rating = {};
...
.controller("kkaCtrl", function($ionicConfig,$scope,$rootScope,$state,$location,$ionicScrollDelegate,$ionicListDelegate,$http,$httpParamSerializer,$stateParams,$timeout,$interval,$ionicLoading,$ionicPopup,$ionicPopover,$ionicActionSheet,$ionicSlideBoxDelegate,$ionicHistory,ionicMaterialInk,ionicMaterialMotion,$window,$ionicModal,base64,md5,$document,$sce,$ionicGesture,$translate,tmhDynamicLocale){
	...
	// TODO: kkaCtrl --|-- $scope.scrollTop
	$rootScope.scrollTop = function(){
		$timeout(function(){
			$ionicScrollDelegate.$getByHandle("top").scrollTop();
		},100);
	};
	// TODO: kkaCtrl --|-- $scope.toggleGroup
	$scope.toggleGroup = function(group) {
		if ($scope.isGroupShown(group)) {
			$scope.shownGroup = null;
		} else {
	...
	// TODO: kkaCtrl --|-- controller_by_user
	// controller by user 
	function controller_by_user(){
		try {
			...
			console.log("%cerror: %cPage: `kka` and field: `Custom Controller`","color:blue;font-size:18px","color:red;font-size:18px");
			console.dir(e);
		}
	}
	$scope.rating = {};
...
$interval(function() {
 ...
 $scope.$on( "$ionicView.destroy", function( scopes, states ) {
   console.log(states.stateName)
        if( states.fromCache && states.stateName == "gsja_tesalonika_app.radio" ) {
            $rootScope.radio_toggle_state = false;
 	radioAudioPlayer.pause();
...
// TODO: renunganCtrl --|-- 
.controller("renunganCtrl", function($ionicConfig,$scope,$rootScope,$state,$location,$ionicScrollDelegate,$ionicListDelegate,$http,$httpParamSerializer,$stateParams,$timeout,$interval,$ionicLoading,$ionicPopup,$ionicPopover,$ionicActionSheet,$ionicSlideBoxDelegate,$ionicHistory,ionicMaterialInk,ionicMaterialMotion,$window,$ionicModal,base64,md5,$document,$sce,$ionicGesture,$translate,tmhDynamicLocale){
	...
	$rootScope.grid128 = parseInt($rootScope.ionWidth / 128) ;
	$rootScope.grid256 = parseInt($rootScope.ionWidth / 256) ;
	$rootScope.last_edit = "table (renungan)" ;
	$scope.$on("$ionicView.afterEnter", function (){
		var page_id = $state.current.name ;
		$rootScope.page_id = page_id.replace(".","-") ;
	});
	...
	// TODO: renunganCtrl --|-- $scope.scrollTop
	$rootScope.scrollTop = function(){
		$timeout(function(){
			$ionicScrollDelegate.$getByHandle("top").scrollTop();
		},100);
	};
	// TODO: renunganCtrl --|-- $scope.toggleGroup
	$scope.toggleGroup = function(group) {
		if ($scope.isGroupShown(group)) {
			$scope.shownGroup = null;
		} else {
	...
	// TODO: renunganCtrl --|-- $scope.redirect
	// redirect
	$scope.redirect = function($url){
		$window.location.href = $url;
	};
	...
	// TODO: renunganCtrl --|-- $scope.showAuthentication
	...
	//fix url Renungan
	targetQuery = "json=renungan"; //default param
	raplaceWithQuery = "json=renungan";
	
	
	// TODO: renunganCtrl --|-- $scope.splitArray
	...
	// TODO: renunganCtrl --|-- $scope.fetchURL
	$scope.fetchURL = "http://beliaccessories.com/apps/gsja_tesalonika/rest_api.php?json=renungan";
	// TODO: renunganCtrl --|-- $scope.fetchURLp
	$scope.fetchURLp = "http://beliaccessories.com/apps/gsja_tesalonika/rest_api.php?json=renungan&callback=JSON_CALLBACK";
	// TODO: renunganCtrl --|-- $scope.hashURL
	...
	localforage.getItem("data_renungans_" + $scope.hashURL, function(err, get_renungans){
		if(get_renungans === null){
			data_renungans =[];
		}else{
			data_renungans = JSON.parse(get_renungans);
			$scope.data_renungans =JSON.parse( get_renungans);
			$scope.renungans = [];
			for(lastPush = 0; lastPush < 50; lastPush++) {
				if (angular.isObject(data_renungans[lastPush])){
					$scope.renungans.push(data_renungans[lastPush]);
				};
			}
			$timeout(function() {
				$ionicLoading.hide();
	...
	if(data_renungans === null ){
		data_renungans =[];
	}
	if(data_renungans.length === 0 ){
		$timeout(function() {
			...
			// TODO: renunganCtrl --|-- $http.get
			$http.get(url_request,http_header).then(function(response) {
				data_renungans = response.data;
				$scope.data_renungans = response.data;
				// TODO: renunganCtrl --|---------- set:localforage
				localforage.setItem("data_renungans_" + $scope.hashURL, JSON.stringify(data_renungans));
				$scope.renungans = [];
				for(lastPush = 0; lastPush < 50; lastPush++) {
					if (angular.isObject(data_renungans[lastPush])){
						$scope.renungans.push(data_renungans[lastPush]);
				...
				$timeout(function() {
					...
					if(response.status ===401){
						// TODO: renunganCtrl --|------------ error:Unauthorized
						$scope.showAuthentication();
					}else{
						// TODO: renunganCtrl --|------------ error:Message
			...
			$timeout(function() {
				$ionicLoading.hide();
				controller_by_user();
				if(angular.isDefined($scope.data_renungans.data)){
					if($scope.data_renungans.data.status ===401){
						$scope.showAuthentication();
						return false;
					}
				}
	...
	// TODO: renunganCtrl --|-- $scope.doRefresh
	...
	// TODO: renunganCtrl --|-- controller_by_user
	// controller by user 
	function controller_by_user(){
		try {
			
//debug: all data
//console.log(data_renungans);
$ionicConfig.backButton.text("");
			
		} catch(e){
			console.log("%cerror: %cPage: `renungan` and field: `Custom Controller`","color:blue;font-size:18px","color:red;font-size:18px");
			console.dir(e);
		}
	}
	$scope.rating = {};
...
// TODO: renungan_singlesCtrl --|-- 
.controller("renungan_singlesCtrl", function($ionicConfig,$scope,$rootScope,$state,$location,$ionicScrollDelegate,$ionicListDelegate,$http,$httpParamSerializer,$stateParams,$timeout,$interval,$ionicLoading,$ionicPopup,$ionicPopover,$ionicActionSheet,$ionicSlideBoxDelegate,$ionicHistory,ionicMaterialInk,ionicMaterialMotion,$window,$ionicModal,base64,md5,$document,$sce,$ionicGesture,$translate,tmhDynamicLocale){
	...
	// TODO: renungan_singlesCtrl --|-- $scope.scrollTop
	$rootScope.scrollTop = function(){
		$timeout(function(){
			$ionicScrollDelegate.$getByHandle("top").scrollTop();
		},100);
	};
	// TODO: renungan_singlesCtrl --|-- $scope.toggleGroup
	$scope.toggleGroup = function(group) {
		if ($scope.isGroupShown(group)) {
			$scope.shownGroup = null;
		} else {
	...
	// TODO: renungan_singlesCtrl --|-- $scope.redirect
	// redirect
	$scope.redirect = function($url){
		$window.location.href = $url;
	};
	...
	// TODO: renungan_singlesCtrl --|-- $scope.showAuthentication
	$scope.showAuthentication  = function(){
		var authPopup = $ionicPopup.show({
			template: ' This page required login',
			title: "Authorization",
	...
	// TODO: renungan_singlesCtrl --|-- $scope.fetchURL
	$scope.fetchURL = "http://beliaccessories.com/apps/gsja_tesalonika/rest_api.php?json=renungan";
	// TODO: renungan_singlesCtrl --|-- $scope.fetchURLp
	$scope.fetchURLp = "http://beliaccessories.com/apps/gsja_tesalonika/rest_api.php?json=renungan&callback=JSON_CALLBACK";
	// TODO: renungan_singlesCtrl --|-- $scope.hashURL
	$scope.hashURL = md5.createHash($scope.fetchURL);
	
	var current_item = [];
	localforage.getItem("data_renungans_" + $scope.hashURL, function(err, get_datas){
		if(get_datas === null){
			current_item = [];
		}else{
			if(get_datas !== null){
	...
	if( current_item.length === 0 ){
		...
		// TODO: renungan_singlesCtrl --|-- $http.get
		$http.get($scope.fetchURL,http_header).then(function(response) {
			// Get data single
			var datas = response.data;
			// TODO: renungan_singlesCtrl --|---------- set:localforage
			localforage.setItem("data_renungans_"+ $scope.hashURL,JSON.stringify(datas));
			for (var i = 0; i < datas.length; i++) {
				if((datas[i].id ===  parseInt(itemID)) || (datas[i].id === itemID.toString())) {
					current_item = datas[i] ;
				}
		...
		// TODO: renungan_singlesCtrl --|-- $scope.doRefresh
	$scope.doRefresh = function(){
		// Retrieving data
		var itemID = $stateParams.id;
		var current_item = [];
		...
		$http.get($scope.fetchURL,http_header).then(function(response) {
			...
			// Error message
		// TODO: renungan_singlesCtrl --|---------- $http.jsonp
	...
	// TODO: renungan_singlesCtrl --|-- controller_by_user
	// controller by user 
	function controller_by_user(){
		try {
...
$ionicConfig.backButton.text("");			
			...
			console.log("%cerror: %cPage: `renungan_singles` and field: `Custom Controller`","color:blue;font-size:18px","color:red;font-size:18px");
			console.dir(e);
		}
	}
	$scope.rating = {};
...
.controller("videoCtrl", function($ionicConfig,$scope,$rootScope,$state,$location,$ionicScrollDelegate,$ionicListDelegate,$http,$httpParamSerializer,$stateParams,$timeout,$interval,$ionicLoading,$ionicPopup,$ionicPopover,$ionicActionSheet,$ionicSlideBoxDelegate,$ionicHistory,ionicMaterialInk,ionicMaterialMotion,$window,$ionicModal,base64,md5,$document,$sce,$ionicGesture,$translate,tmhDynamicLocale){
	...
	$scope.fetchURL = "https://www.googleapis.com/youtube/v3/playlistItems?maxResults=50&part=id,snippet&playlistId=PLSNYh5IVAqkfEOyVDHgv4y3Mv8atMVlxa&key=AIzaSyBPbRYTeJh2k1i-svHRqpIJJ78wFsGbECU";
	// TODO: videoCtrl --|-- $scope.fetchURLp
	$scope.fetchURLp = "https://www.googleapis.com/youtube/v3/playlistItems?maxResults=50&part=id,snippet&playlistId=PLSNYh5IVAqkfEOyVDHgv4y3Mv8atMVlxa&key=AIzaSyBPbRYTeJh2k1i-svHRqpIJJ78wFsGbECU&callback=JSON_CALLBACK";
...
// TODO: young_adultsCtrl --|-- 
.controller("young_adultsCtrl", function($ionicConfig,$scope,$rootScope,$state,$location,$ionicScrollDelegate,$ionicListDelegate,$http,$httpParamSerializer,$stateParams,$timeout,$interval,$ionicLoading,$ionicPopup,$ionicPopover,$ionicActionSheet,$ionicSlideBoxDelegate,$ionicHistory,ionicMaterialInk,ionicMaterialMotion,$window,$ionicModal,base64,md5,$document,$sce,$ionicGesture,$translate,tmhDynamicLocale){
	...
	// TODO: young_adultsCtrl --|-- $scope.scrollTop
	$rootScope.scrollTop = function(){
		$timeout(function(){
			$ionicScrollDelegate.$getByHandle("top").scrollTop();
		},100);
	};
	// TODO: young_adultsCtrl --|-- $scope.toggleGroup
	$scope.toggleGroup = function(group) {
		if ($scope.isGroupShown(group)) {
			$scope.shownGroup = null;
		} else {
	...
	// TODO: young_adultsCtrl --|-- $scope.redirect
	// redirect
	$scope.redirect = function($url){
		$window.location.href = $url;
	};
	...
	// TODO: young_adultsCtrl --|-- controller_by_user
	// controller by user 
	function controller_by_user(){
		try {
			...
			console.log("%cerror: %cPage: `young_adults` and field: `Custom Controller`","color:blue;font-size:18px","color:red;font-size:18px");
			console.dir(e);
		}
	}
	$scope.rating = {};
...
// TODO: youth_serviceCtrl --|-- 
.controller("youth_serviceCtrl", function($ionicConfig,$scope,$rootScope,$state,$location,$ionicScrollDelegate,$ionicListDelegate,$http,$httpParamSerializer,$stateParams,$timeout,$interval,$ionicLoading,$ionicPopup,$ionicPopover,$ionicActionSheet,$ionicSlideBoxDelegate,$ionicHistory,ionicMaterialInk,ionicMaterialMotion,$window,$ionicModal,base64,md5,$document,$sce,$ionicGesture,$translate,tmhDynamicLocale){
	...
	// TODO: youth_serviceCtrl --|-- $scope.scrollTop
	$rootScope.scrollTop = function(){
		$timeout(function(){
			$ionicScrollDelegate.$getByHandle("top").scrollTop();
		},100);
	};
	// TODO: youth_serviceCtrl --|-- $scope.toggleGroup
	$scope.toggleGroup = function(group) {
		if ($scope.isGroupShown(group)) {
			$scope.shownGroup = null;
		} else {
	...
	// TODO: youth_serviceCtrl --|-- $scope.redirect
	// redirect
	$scope.redirect = function($url){
		$window.location.href = $url;
	};
	...
	// TODO: youth_serviceCtrl --|-- controller_by_user
	// controller by user 
	function controller_by_user(){
		try {
			...
			console.log("%cerror: %cPage: `youth_service` and field: `Custom Controller`","color:blue;font-size:18px","color:red;font-size:18px");
			console.dir(e);
		}
	}
	$scope.rating = {};
